...
export const generateQuizesByDate = async (req, res, db) => {
    try {
        ...
        const prompt = `Create and return at least 10 quiz with at most 4 multiple-choice questions based on the following text. Each question should include the question and an array of 4 options, where each option indicates whether it is correct. Format the output as a JSON array of objects. Here's the text: "${oneString}"`;
